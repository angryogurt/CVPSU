...
class Book(VideoSynthBase):
    def __init__(self, **kw):
        ...
        backGr = cv.imread('../Mask_RCNN/data/graf1.png')
        fgr = cv.imread('../Mask_RCNN/data/box.png')
...
class Cube(VideoSynthBase):
    def __init__(self, **kw):
        ...
        self.render = TestSceneRender(cv.imread('../Mask_RCNN/data/pca_test1.jpg'), deformation = True, speed = 1)
